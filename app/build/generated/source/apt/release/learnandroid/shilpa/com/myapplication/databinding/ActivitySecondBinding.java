...
public class ActivitySecondBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    private learnandroid.shilpa.com.myapplication.viewmodel.User mUser;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, Object variable) {
        switch(variableId) {
            case BR.user :
                setUser((learnandroid.shilpa.com.myapplication.viewmodel.User) variable);
                return true;
        }
        return false;
    }

    public void setUser(learnandroid.shilpa.com.myapplication.viewmodel.User user) {
        this.mUser = user;
        synchronized(this) {
            mDirtyFlags |= 0x8L;
        }
    ...
    public learnandroid.shilpa.com.myapplication.viewmodel.User getUser() {
        return mUser;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 2 :
                return onChangeLastnameUser((android.databinding.ObservableField<java.lang.String>) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeLastnameUser(android.databinding.ObservableField<java.lang.String> lastnameUser, int fieldId) {
        switch (fieldId) {
            case BR._all: {
                synchronized(this) {
                        mDirtyFlags |= 0x4L;
    ...
    protected void executeBindings() {
        ...
        android.databinding.ObservableField<java.lang.String> lastnameUser1 = null;
        learnandroid.shilpa.com.myapplication.viewmodel.User user = mUser;
        ...
        if ((dirtyFlags & 0x1fL) != 0) {
            ...
            if ((dirtyFlags & 0x1cL) != 0) {
                    ...
                    if (user != null) {
                        // read user.lastname
                        lastnameUser1 = user.lastname;
                    }
                    updateRegistration(2, lastnameUser1);


                    if (lastnameUser1 != null) {
                        // read user.lastname.get()
                        lastnameUser = lastnameUser1.get();
                    }
            }
        }
        // batch finished
